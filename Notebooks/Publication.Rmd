...
ps_bact_filtered@tax_table[microbiome::core_members(microbiomeMarker::normalize(ps_bact_filtered, method="TSS"), detection = 1/10000 , prevalence = 70/100)]
...
physeq_hospital <- subset_samples(ps_bact_filtered, Regional_Hospital == "yes")

# Filter for non-hospital samples
physeq_nonhospital <- subset_samples(ps_bact_filtered, Regional_Hospital == "no")


# physeq_hospital@tax_table[microbiome::core_members(microbiomeMarker::normalize(physeq_hospital, method="TSS"), detection = 1/10000 , prevalence = 70/100)]
# physeq_nonhospital@tax_table[microbiome::core_members(microbiomeMarker::normalize(physeq_nonhospital, method="TSS"), detection = 1/10000 , prevalence = 70/100)]

core_hospital <- microbiome::core(physeq_hospital, detection=1, prevalence=0.7)

# Core in non-hospital samples
core_nonhospital <- microbiome::core(physeq_nonhospital, detection=1, prevalence=0.7)
...
```{r}
physeq_nonhospital@tax_table[unique_hospital]
```
