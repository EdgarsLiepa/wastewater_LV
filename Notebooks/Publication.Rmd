...
# Save as PNG
ggsave("../plots/city_genus_barplot.png", plot = genus_plot, width = 12, height = 8, units = "in", dpi = 300)
...
ps_tax_ww_impact = subset_samples(ps_bact_filtered, sample_data(ps_bact_filtered)$Industrial_wastewater_impact != "Na")
...
ps_tax_ww_impact = subset_samples(ps_CSS, sample_data(ps_CSS)$Industrial_wastewater_impact != "Na")
...
ps_tax_ww_impact = subset_samples(ps_CSS, sample_data(ps_CSS)$Industrial_wastewater_impact_from_food != "Na")
