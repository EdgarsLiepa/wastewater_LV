...
alph_city <- plot_richness(ps_scaffolds_filtered, x="City", title="AMR diversity", measures=c("InvSimpson", "Shannon"), nrow = 2, sortby = "Shannon") + 
    geom_boxplot() + 
    theme_bw() +
...
# Save as PNG
ggsave("../plots/arg_alpha_city_2.png", plot = alph_city, width = 7.2, height = 6, units = "in", dpi = 1200)

# Save as SVG
ggsave("../plots/arg_alpha_city_2.svg", plot = alph_city, width = 7.2, height = 6, units = "in", dpi = 1200)
...
# # Save as PNG
# ggsave("../plots/arg_alpha_hospital.png", plot = r_plot, width = 24, height = 12, units = "in", dpi = 300)
# 
# # Save as SVG
